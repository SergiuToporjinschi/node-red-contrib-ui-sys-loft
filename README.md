[![npm version](https://img.shields.io/npm/v/node-red-contrib-ui-progress.svg?style=flat-square)](https://www.npmjs.com/package/node-red-contrib-ui-progress?activeTab=versions)
[![npm](https://img.shields.io/npm/dt/node-red-contrib-ui-progress.svg)](https://www.npmjs.com/package/node-red-contrib-ui-progress)
[![npm downloads](https://img.shields.io/npm/dm/node-red-contrib-ui-progress.svg?style=flat-square)](https://www.npmjs.com/package/node-red-contrib-ui-progress)
[![GitHub repo size in bytes](https://img.shields.io/github/repo-size/badges/shields.svg)](https://github.com/SergiuToporjinschi/node-red-contrib-ui-progress)
[![GitHub last commit](https://img.shields.io/github/last-commit/SergiuToporjinschi/node-red-contrib-ui-progress.svg)](https://github.com/SergiuToporjinschi/node-red-contrib-ui-progress/commits/master)
[![GitHub stars](https://img.shields.io/github/stars/SergiuToporjinschi/node-red-contrib-ui-progress.svg)](https://github.com/SergiuToporjinschi/node-red-contrib-ui-progress/stargazers)
[![GitHub watchers](https://img.shields.io/github/watchers/SergiuToporjinschi/node-red-contrib-ui-progress.svg)](https://github.com/SergiuToporjinschi/node-red-contrib-ui-progress/watchers)
[![GitHub license](https://img.shields.io/github/license/SergiuToporjinschi/node-red-contrib-ui-progress.svg)](https://github.com/SergiuToporjinschi/node-red-contrib-ui-progress/blob/master/LICENSE)
[![Code Climate](https://codeclimate.com/github/codeclimate/codeclimate/badges/gpa.svg)](https://codeclimate.com/github/SergiuToporjinschi/node-red-contrib-ui-progress)
[![Package Quality](http://npm.packagequality.com/shield/node-red-contrib-ui-progress.svg)](http://packagequality.com/#?package=node-red-contrib-ui-progress)

# node-red-contrib-ui-progress
A dashboard ui interface node for controlling a heater;

## Interface
![image](https://github.com/SergiuToporjinschi/node-red-contrib-ui-progress/raw/master/images/front-end.png)
...
* Fixing (ticket [not working with latest node-red version 0.20.3 #20](https://github.com/SergiuToporjinschi/node-red-contrib-ui-progress/issues/20))
### v1.2.1 (March 13, 2019)
* Allowing negative values in hysteresis (ticket [Allow a minus figure in the upper hysteresis entry #18](https://github.com/SergiuToporjinschi/node-red-contrib-ui-progress/issues/18))
* Update documentation (ticket [Padlock function ? #17](https://github.com/SergiuToporjinschi/node-red-contrib-ui-progress/issues/17))
* Changeable Calendar by message (ticket [Changeable Calendar by message #16](https://github.com/SergiuToporjinschi/node-red-contrib-ui-progress/issues/16))
